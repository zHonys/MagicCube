...
{
    public class FreeCamera : IUpdatable
    {
        //1d Vars
        public float Speed;
        ...
        public FreeCamera(KeyboardState keyboardState, MouseState mouse, float speed, float fov, int sensitivity, Vector2 screenSize, float depthNear, float depthFar)
        {
